...
COLOR_RGB_APPLE: ColorRGB = (0xff, 0xcc, 0x22)
COLOR_RGB_CORPSE: ColorRGB = (0x33, 0x66, 0xff)
COLOR_RGB_MOUSE: ColorRGB = (0x88, 0x88, 0x88)
COLOR_RGB_SNAKE: ColorRGB = (0xff, 0x44, 0x44)
COLOR_RGB_WALL: ColorRGB = (0x44, 0x77, 0x44)
COLOR_RGB_WATERMELON: ColorRGB = (0x0, 0xcc, 0x0)
